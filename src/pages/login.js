...
export default function Login() {
    ...
    const [emailAddress, setEmailAddress] = useState('gast@gast.de');
    const [password, setPassword] = useState('gast1234');
    ...
    useEffect(() => {
        document.title = 'Login - Instaclone - for learning purposes';
    }, []);
